...
wave: 1
depends_on: []
files_modified: [app/.env.example]
autonomous: true
---

<objective>
Create a comprehensive .env.example file documenting all environment variables with their defaults, requirements, and usage examples.

Purpose: Self-documenting configuration enables agents to understand exactly what settings exist without reading source code. A well-documented .env.example is the single source of truth for configuration.

Output: Complete .env.example file in the app directory that agents can copy and customize.
</objective>

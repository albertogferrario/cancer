...
pub fn generate_typescript(routes: &[GeneratedRoute]) -> String {
    ...
    output.push_str("// This file is auto-generated by Cancer. Do not edit manually.\n");
    output.push_str("// Run `cancer generate-types` to regenerate.\n");
...
pub fn run(output: Option<String>) {
    ...
    // Validate Cancer project
    let cargo_toml = project_path.join("Cargo.toml");
    if !cargo_toml.exists() {
        eprintln!(
            "{} Not a Cancer project (no Cargo.toml found)",

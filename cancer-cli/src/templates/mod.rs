...
///
/// The CancerModel derive macro (applied in entities/{table}.rs) generates:
...
//!
//! The CancerModel derive macro provides the Eloquent-like API:
...
// Re-export the auto-generated entity (includes CancerModel-generated code)
...
mod tests {
    ...
    #[test]
    fn test_cancer_guidelines_template_not_empty() {
        let content = cancer_guidelines_template();
        assert!(!content.is_empty());
    ...
    fn test_user_model_template_generates_minimal_file() {
        ...
        assert!(result.contains("impl cancer::auth::Authenticatable for Model"));
        // Should NOT contain manual method implementations (now generated by CancerModel macro)
    ...
    fn test_entity_template_includes_cancer_model_derive() {
        ...
        assert!(result.contains("CancerModel"));
        assert!(result.contains("use cancer::CancerModel"));
    }
